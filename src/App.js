...
class App extends Component {
  state = {
    ...
    //     link:
    //       "https://drive.google.com/open?id=1mLp20F4vGdRCenkg2lfiOg2l17IX5cko",
    //     week: 0
    //   },
    //   {
  ...
  render() {
    return (
      <div className="container">
        ...
        <div className="disclaimer">
          Sorry, Blackboard shut this down after a good three-day run. Will ask
          prof for permission in near-future.
        </div>
